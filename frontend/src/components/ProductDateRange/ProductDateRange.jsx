...
export default function ProductDateRange() {
  ...
  useEffect(() => {
    fetch(`http://localhost:9000/products?pickupDate=${pickupdate}&dropoffDate=${dropoffdate}`, requestConfigurationGet)
  ...
  return (
    <>
      ...
      <div className="city-title">
        <h1> Carros Disponíveis no período de {pickupdate} à {dropoffdate}</h1>
        <div className="left">
          <Link to={"/"}>
